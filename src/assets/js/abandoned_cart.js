...
function initJqueryRetainfulAbandonedCartsTracking() {
    jQuery(function ($) {
        ...
        $('input#billing_email,input#billing_first_name,input#billing_last_name,input#billing_phone,input#rnoc_is_marketting_accepted').on('change', function () {
            ...
            if (!(atposition < 1 || dotposition < atposition + 2 || dotposition + 2 >= rnoc_email.length) || rnoc_phone.length >= 1) {
                ...
                var rnoc_is_marketting_accepted_checkbox = $("#rnoc_is_marketting_accepted");
                var is_marketting_accepted = 1;
                if (rnoc_is_marketting_accepted_checkbox.length > 0) {
                    is_marketting_accepted = (rnoc_is_marketting_accepted_checkbox.is(":checked")) ? 1 : 0;
                }
                var guest_data = {
                    ...
                    is_marketting_accepted: is_marketting_accepted,
