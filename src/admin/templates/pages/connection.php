        ...
        <tr>
            <td colspan="2">
                ...
                if ($is_app_connected) {
                    ...
                    ?>
                    <div style="display:block;background: #fff;border: 1px solid #eee;color:#333;padding: 20px;max-width: 90%;text-align:center;border-radius: 4px;box-shadow: 0 0 5px 0 #ddd;margin: 20px auto;">
