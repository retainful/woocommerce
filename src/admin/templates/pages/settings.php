            ...
            <tr>
                ...
                <td>
                    <input name="<?php echo RNOC_PLUGIN_PREFIX . 'public_api_key'; ?>" type="text"
                           id="<?php echo RNOC_PLUGIN_PREFIX . 'public_api_key'; ?>" value="<?php echo !empty($settings[RNOC_PLUGIN_PREFIX . 'public_api_key']) ? rnocEscAttr(trim($settings[RNOC_PLUGIN_PREFIX . 'public_api_key'])): ''; ?> "
                    >
                    <p class="description">
						<?php
            ...
            <tr>
                ...
                <td>
                    <select name="<?php echo RNOC_PLUGIN_PREFIX . 'customer_status'; ?>">
                        <option value="unsubscribed" <?php echo !empty($settings[RNOC_PLUGIN_PREFIX . 'customer_status']) && ($settings[RNOC_PLUGIN_PREFIX . 'customer_status'] == 'unsubscribed') ? "selected='selected'":''; ?>>
							<?php esc_html_e('Un Subscribed', RNOC_TEXT_DOMAIN); ?></option>
                        <option value="subscribed" <?php echo !empty($settings[RNOC_PLUGIN_PREFIX . 'customer_status']) &&   ($settings[RNOC_PLUGIN_PREFIX . 'customer_status'] == 'subscribed') ? "selected='selected'":''; ?>>
