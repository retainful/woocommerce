...
class Main
{
    ...
    function activateEvents()
    {
        ...
        add_action('wp_ajax_rnoc_save_enable_pro_js', array($this->admin, 'saveEnablePremiumSettings'));
        ...
        if ($is_app_connected && !empty($secret_key) && !empty($app_id)) {
            ...
            */
            ...
            if (!$this->admin->managePremiumFeaturesLocally() && $this->admin->isCloudPremiumJsEnabled()) {
