<div class="rnoc-popup"
    ...
    <div class="rnoc-popup-head">
        <div class="rnoc-lw-title"
             style="color: <?php echo $rnoc_modal_heading_color; ?>;"><?php echo $rnoc_modal_heading; ?></div>
        <p style="color: <?php echo $rnoc_modal_sub_heading_color; ?>;"><?php echo $rnoc_modal_sub_heading; ?></p>
    </div>
    ...
    <div class="rnoc-lw-center">
        <div class="rnoc-lw-field rnoc-popup-form-block">
            ...
            <button style="color: <?php echo $rnoc_modal_add_cart_color ?>;background: <?php echo $rnoc_modal_add_cart_bg_color ?>;"
                    class="rnoc-lw-btn rnoc-popup-btn"><?php echo $rnoc_modal_add_cart_text ?>
            </button>
        </div>
        ...
        if ($rnoc_no_thanks_action) {
            ...
            <a class="no-thanks-close-popup" href="#"
               style="color: <?php echo $rnoc_modal_add_cart_no_thanks_color; ?>;"><?php echo $rnoc_modal_not_mandatory_text ?></a>
            <?php
        }
        ?>
        <span><?php echo $rnoc_modal_terms_text ?></span>
    </div>
