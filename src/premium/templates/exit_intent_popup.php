<div class="rnoc-popup-holder"
    ...
    <div class="rnoc-content">
        ...
        <div class="rnoc-popup-form-block"
            ...
            <input type="email" id="rnoc-popup-email-field"
                   placeholder="<?php echo $rnoc_exit_intent_modal_email_placeholder ?>"
                   class="rnoc-popup-input" <?php echo $rnoc_popup_email_field ?>
            ...
            <button class="rnoc-popup-btn"
                ...
                <?php echo $rnoc_exit_intent_modal_add_cart_text ?>
            </button>
        </div>
    ...
    <div style="margin: 20px auto;color: #5f5f5f;text-align: center;"><?php echo $rnoc_exit_intent_modal_terms_text ?></div>
</div>