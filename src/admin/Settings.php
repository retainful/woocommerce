    ...
    function renderPage()
    {
        add_action('cmb2_admin_init', function () {
            ...
            $general_settings->add_field(array(
                ...
                'desc' => __('This message will attached to the Order Email.<br>Please use the below short codes to show the Coupon details in the message.<br><b>{{coupon_code}}</b> - Coupon code<br><b>{{coupon_amount}}</b> - Coupon amount<br><b>{{coupon_url}}</b> - Url to apply coupon automatically<br><br>', RNOC_TEXT_DOMAIN)
            ));
        });
    }
