...
//              self::$settings->logMessage($http_args, 'http import product data');
    ...
    protected function getProductData($product_id)
    {
        ...
        if ($product->is_type('variable')) {
            ...
            foreach ($variations as $variation) {
                ...
                $product_variation[] = [
                    ...
                    'variant_stock_quantity' => !empty($variation_obj->get_stock_quantity()) ? $product->get_stock_quantity() : 0,
        ...
        $product_data = [
            ...
            'product_stock_quantity' => !empty($product->get_stock_quantity()) ? $product->get_stock_quantity() : 0,
