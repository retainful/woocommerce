...
<h2 class="nav-tab-wrapper">
    ...
    <?php endif; ?>
    <?php if($is_premium_addons !== 'yes'):?>
        <a class="nav-tab <?php if($page=='retainful_premium'){echo "nav-tab-active";} ?>" href="<?php echo admin_url('admin.php?page=retainful_premium');?>"><?php esc_html_e('Premium',RNOC_TEXT_DOMAIN); ?>
            Features</a>
    <?php endif; ?>
</h2>