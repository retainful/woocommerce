...
Remember: WooCommerce uses the <a target='_blank' href='%s'>Scheduled Actions</a> to execute webhooks in the background for this. So, make sure your cron setup is correct. If cron isn't working, order details won't reach Retainful API, and your workflow triggers won't work right.", 'retainful-next-order-coupon-for-woocommerce'), $scheduled_action);
        ...
        <tr>
            ...
            <td>
                ...
                ><?php echo \Rnoc\App\Helpers\Input::rnocEscAttr(trim($settings[RNOC_PLUGIN_PREFIX . 'cart_capture_msg'])); ?>
                </textarea>
                <p class="description">
                    <?php
        ...
        <tr>
            ...
            <td>
                ...
                ><?php echo \Rnoc\App\Helpers\Input::rnocEscAttr(trim($settings[RNOC_PLUGIN_PREFIX . 'ignored_ip_addresses'])); ?>
                </textarea>
                <p class="description">
                    <?php
