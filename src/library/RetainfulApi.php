...
class RetainfulApi
{
    ...
    {
        return 'https://app.retainful.com/app/settings/billing/plans?utm_source=retainful-free&utm_medium=plugin&utm_campaign=inline-addon&utm_content=premium-addon';
    }
