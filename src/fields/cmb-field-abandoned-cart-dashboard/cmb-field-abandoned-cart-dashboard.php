            ...
            <div class="rnoc_counter_widget widget_green card_main_box <?php echo $width_class; ?>">
                <div class="rnoc_counter_container">
                    <div class="rnoc_widget_title_container">
                        <span class="rnoc_counter_title card-box-name"><?php echo __('Recovered Revenue', RNOC_TEXT_DOMAIN); ?></span>
                    </div>
            ...
            <div class="rnoc_counter_widget widget_blue card_main_box <?php echo $width_class; ?>">
                <div class="rnoc_counter_container">
                    ...
                    <div class="avatar-lg avatar-lg-3">
                        <img src="<?php echo RNOC_PLUGIN_URL; ?>src/assets/images/icon-3.png" class="img_icon"
                             alt="Abandoned Carts">
                    </div>
        ...
        <div class="rnoc_counter_container retainful_abandoned_container">
            ...
            <div class="rnoc_counter_widget widget_orange card_main_box <?php echo $width_class; ?>">
                <div class="rnoc_countcmb-type-abandoned-cart-dashboarder_container">
                    <div class="rnoc_widget_title_container">
                        <span class="rnoc_counter_title card-box-name"><?php echo __('Abandoned Revenue', RNOC_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="avatar-lg avatar-lg-2">
                        <img src="<?php echo RNOC_PLUGIN_URL; ?>src/assets/images/icon-2.png" class="img_icon"
                             alt="Abandoned Carts">
                    </div>
            ...
            <div class="rnoc_counter_widget widget_violet card_main_box <?php echo $width_class; ?>">
                <div class="rnoc_counter_container">
                    ...
                    <div class="avatar-lg avatar-lg-1">
                        <img src="<?php echo RNOC_PLUGIN_URL; ?>src/assets/images/icon-1.png" class="img_icon"
                             alt="Abandoned Carts">
                    </div>
            ...
            <div class="rnoc_counter_widget widget_green card_main_box <?php echo $width_class; ?>">
                <div class="rnoc_counter_container">
                    <div class="rnoc_widget_title_container">
                        <span class="rnoc_counter_title card-box-name"><?php echo __('Recoverable Carts', RNOC_TEXT_DOMAIN); ?> &nbsp;<small>(<?php echo __('Carts with known email', RNOC_TEXT_DOMAIN); ?>)</small></span>
                    </div>
                    <div class="avatar-lg avatar-lg-4">
                        <img src="<?php echo RNOC_PLUGIN_URL; ?>src/assets/images/icon-4.png" class="img_icon"
                             alt="Recoverable Carts">
                    </div>
                    <div class="rnoc_counter_body card-box-value" id="rnoc_recovered_total">
                        <?php echo $cart_details['recoverable_carts']; ?>
                    </div>
                </div>
            </div>
        </div>
