    ...
    jQuery(function ($) {
        ...
        $('input#billing_email,input#billing_first_name,input#billing_last_name,input#billing_phone,.wc-block-components-checkout-form input#phone,.wc-block-components-checkout-form input#email').on('change', function () {
            ...
            if (typeof rnoc_email === 'undefined') {
                rnoc_email = $(".wc-block-components-checkout-form input#email").val();
                if (typeof rnoc_email === 'undefined') {
                    return;
                }
            }
            ...
            if (typeof rnoc_phone === 'undefined' || rnoc_phone === null) { //If phone number field does not exist on the Checkout form
                rnoc_phone = $(".wc-block-components-checkout-form input#phone").val();
                if (typeof rnoc_phone === 'undefined' || rnoc_phone === null) {
                    rnoc_phone = '';
                }
            }
